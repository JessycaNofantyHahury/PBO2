...
public class GameFrame extends JFrame {
    ...
    private JButton pindahAtas;
    private JButton pindahBawah;
    private JButton pindahserongKananAtas;
    private JButton pindahserongKananBawah;  
    private JButton pindahserongKiriAtas;
    private JButton pindahserongKiriBawah;  
    ...
    public void init() {
        ...
        this.pindahAtas = new JButton("Atas");
        southPanel.add(pindahAtas);
        
           pindahAtas.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                pindahAtas();
                }
           ...
           this.pindahBawah = new JButton("Bawah");
           southPanel.add(pindahBawah);
           
              pindahBawah.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                pindahBawah();
                }
           ...
           this.pindahserongKananAtas = new JButton("Serong Kanan Atas");
           southPanel.add(pindahserongKananAtas);
           
              pindahserongKananAtas.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SerongKananAtas();
                }
               ...
               this.pindahserongKananAtas = new JButton("Serong Kanan Bawah");
           southPanel.add(pindahserongKananAtas);
           ...
           this.pindahserongKiriAtas = new JButton("Serong Kiri Atas");
           southPanel.add(pindahserongKiriAtas);
           
              pindahserongKiriAtas.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SerongKiriAtas();
                }
              ...
              this.pindahserongKiriBawah = new JButton("Serong Kiri Bawah");
           southPanel.add(pindahserongKiriBawah);
           
              pindahserongKiriBawah.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SerongKiriBawah();
                }
